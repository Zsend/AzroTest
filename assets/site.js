(function(){
  ...
  function setupRevealTargets(){
    const selectors = '.card, .letter-card, .archive-card, .minimum-card, .path-card, .support-card, .source-card, .compare-card, .proof-card, .panel, .voice-card, .room-card, .hero-side .thesis-card, .hero-side .photo-card';
