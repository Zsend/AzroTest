(function(){
  ...
  function setupActiveNav(){
    ...
    if(!map.size) return;
    const clear = function(){ links.forEach(function(link){ link.classList.remove('is-active'); }); };
    const observer = new IntersectionObserver(function(entries){
      ...
      if(visible){ clear(); const link = map.get(visible.target); if(link) link.classList.add('is-active'); }
