(() => {
  ...
  function renderChart(host) {
    ...
    [["0%", "#b51f50"], ["52%", "#efbb4d"], ["100%", "#94ba76"]].forEach(([offset, color]) => {
    ...
    areaGradient.appendChild(make("stop", { offset: "0%", "stop-color": "#efbb4d", "stop-opacity": ".16" }));
    areaGradient.appendChild(make("stop", { offset: "100%", "stop-color": "#94ba76", "stop-opacity": "0" }));
    ...
    pts.forEach((point, index) => {
      const pointColor = index === 0 ? "#b51f50" : index === pts.length - 1 ? "#94ba76" : "#efbb4d";
