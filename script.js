...
(function(){
  ...
  const paintChart = (chart, raw, reduced) => {
    // v147: the Benchmark Lens chart is a build-up proof graphic, not a
    // reversible progress meter. It may grow as the reader scrolls down, but
    // it should never visually undraw while scrolling back up. Reloading the
    // page naturally resets this per-page-load memory.
