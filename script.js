(function(){
  ...
  if (closingScrollCards.length) {
    ...
    window.addEventListener('scroll', scheduleClosingScrollUpdate, { passive: true });
...
/* =====================================================================
   v150 — consolidated production interaction engine.
...
// v150 publish-readiness hardening: consolidated scroll engines, one-way chart replay from above, and cache/version finalization.
