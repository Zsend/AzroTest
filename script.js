...
(function(){
  function updateCTAPad(){ var el = document.querySelector('.sticky-cta, .buy-cta, .cta-sticky, [data-sticky-cta]'); var h = 0; if(el){ var r = el.getBoundingClientRect(); h = Math.ceil(r.height || 0); } document.documentElement.style.setProperty('--cta-bottom-h', h + 'px'); }
