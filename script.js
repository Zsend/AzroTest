  ...
  if (!modal) {
    ...
    modal.innerHTML = `
      ...
      <div class="modal__dialog modal__dialog--support" role="dialog" aria-modal="true" aria-labelledby="supportModalTitle">
        ...
        <p class="support-modal__lead">Use the email below for free trial questions, access issues, setup questions, alert troubleshooting, payment verification, or TradingView username changes.</p>
        <div class="support-modal__rows" aria-label="Support checklist">
          <div class="support-modal__row"><strong>Include</strong><span>TradingView username, product, receipt / TXID if relevant, and a full chart screenshot when relevant.</span></div>
