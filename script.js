(function(){
  ...
  // v115: mobile stability guard, intentionally non-invasive.
  ...
  const RS_SCROLL_STATE_KEY = 'rs_scroll_state_v115';
  ...
  // v115 customer-ready build — last-known-good scroll engine restored — refined hero scale, precision section anchoring, replayable downward card reveals, final color polish, and production launch fixes.
...
/* v115: seam and outcome-call progress calibration.
