  ...
  if (!modal) {
    ...
    modal.innerHTML = `
      ...
      <div class="modal__dialog modal__dialog--support" role="dialog" aria-modal="true" aria-labelledby="supportModalTitle">
        ...
        <p class="support-modal__lead">Use the email below for free trial requests, access issues, setup questions, alert troubleshooting, payment verification, or TradingView username changes.</p>
