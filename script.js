(function(){
  ...
  // v119: mobile stability guard, intentionally non-invasive.
  ...
  const RS_SCROLL_STATE_KEY = 'rs_scroll_state_v119';
  ...
  // v119 customer-ready build — last-known-good scroll engine restored — refined hero scale, precision section anchoring, replayable downward card reveals, final color polish, and production launch fixes.
  ...
  // v119: chart motion is owned by the final chart scrub engine at the end of this file.
...
/* v119: seam and outcome-call progress calibration.
...
/* =====================================================================
   v119 — proof chart + long-run line scroll engine, rebuilt cleanly.
