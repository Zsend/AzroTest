          ...
          if (allowPreviewAutoplay) {
            ...
            const tryInlinePlay = () => {
              ...
              if (playPromise && typeof playPromise.then === 'function') {
                playPromise.then(() => {
                  if (video.readyState >= 2) revealWhenPainted();
                }).catch(() => {});
                return;
              }
              if (video.readyState >= 2) revealWhenPainted();
            ...
            video.addEventListener('loadeddata', revealWhenPainted);
            ...
            video.addEventListener('timeupdate', revealWhenPainted, { once: true });
