...
(() => {
  ...
  forms.forEach((form) => {
    ...
    form.addEventListener('submit', (e) => {
      ...
      const subject = encodeURIComponent('Join AZRO release updates and reward codes');
      const body = encodeURIComponent(`Please add this email to AZRO release updates and reward codes:
