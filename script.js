    ...
    document.querySelectorAll('.section[id]').forEach((section, index) => {
      ...
      if (section.id === 'why-now') {
        whyNowCards.forEach((card, idx) => {
          const start = idx * 0.16;
          const progressWindow = ramp(progress, start, 0.38);
