...
(() => {
  ...
  forms.forEach((form) => {
    ...
    form.addEventListener('submit', (e) => {
      ...
      const subject = encodeURIComponent('Join AZRO product updates and reward codes');
      const body = encodeURIComponent(`Please add this email to AZRO product updates and reward codes:
