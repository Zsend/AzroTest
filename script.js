(() => {
  ...
  const copy = {
    founder: ['Validation access', 'Join BaseRelay validation.', 'Get product updates, tester opportunities, and future controlled pilot invitations. This is not an order or hardware sale.'],
    field: ['Field notes', 'Validation before scale.', 'BaseRelay is collecting field data before broad sale: runtime, setup time, supported sources, confusion points, and failures.'],
    architecture: ['Control standard', 'BaseRelay first architecture', 'The first path is a Core DC Kit plus Control Standard: approved-source guidance, protected delivery, setup instructions, test logs, support boundaries, and claims discipline.'],
    search: ['Search', 'Search is coming soon.', 'Use the navigation for now, or join the validation list and we will send product updates directly.']
  };
