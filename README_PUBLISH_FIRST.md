# Reserve Standard site package V12

This is the current publish-ready GitHub Pages build.
...
V22D update:
- exact settle alignment pass for the Why now left sticky card
- slightly faster Maintained operating system progress line so it reaches the last card before the section clears
