...
## v67 closing-card motion
- Operator Materials and Next Step cards now use the same scroll-driven fade, right-drift, blur reduction, and scale-settle language as the Asset / Problem / System framework cards.
- The sequence is staggered so Operator Materials lands first and Next Step follows.
- The cards respect responsive stacked layouts, preserve hover polish after landing, and avoid horizontal overflow.
