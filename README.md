# AZRO LLC Reserve Standard — auto-scroll final
...
This build updates the public offer naming to **LLC Reserve Standard** and includes desktop chapter auto-scroll behavior.
