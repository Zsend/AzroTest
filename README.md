# A Right For All — GitHub Pages test-ready package
...
- there is **no fixed-domain canonical metadata** yet
...
- `index.html` — homepage
- `letters/` — letter archive, typed excerpts, original PDFs, and preview images
- `unusual-thinkers/` — public builder challenge
- `assets/` — CSS, JS, share card, and tablet photo
- `404.html`
- `.nojekyll`
- `robots.txt`
- `site.webmanifest`
- favicons
- `CNAME.example` and `ENABLE_CUSTOM_DOMAIN_LATER.md`

## Later, when the real domain is ready

Use `CNAME.example` as the template for the real `CNAME` file, or use the custom-domain release ZIP from Brand OS.
...
- `/sources/` public sources and evidence notes
