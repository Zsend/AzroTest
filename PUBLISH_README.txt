Reserve Standard v154 — GitHub Pages publish-ready final

Publish instructions:
1. Upload the full unzipped folder contents to the GitHub Pages repository root.
2. Commit and push.
3. Wait for GitHub Pages to rebuild.
4. Hard refresh / clear browser cache so style.min.css?v=154, script.js?v=154, gate.js?v=154, and site-config.js?v=154 load.

What changed in v154:
- Built from the approved v152 visual-safe performance baseline.
