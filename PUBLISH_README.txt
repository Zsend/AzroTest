Reserve Standard — v95 Final Customer-Ready Build
...
3. Purge CDN/host cache after upload so v95 CSS/JS are served.
4. Test the live site in a fresh incognito window using the access code.
5. Confirm: private gate, top progress rail, sticky navigation, section anchor landing, card scroll reveals, review form mailto behavior, PDFs, footer links, sitemap, and robots.txt.
