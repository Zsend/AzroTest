...
PUBLIC_FILES = [
    ...
    "assets/mark.svg", "assets/site.css", "assets/product.css", "assets/trust.css",
    "assets/home.js", "assets/static-api.js", "assets/social-card.png",
...
def main() -> int:
    ...
    if 'release: "2026.06.19-github-pages.3"' not in config:
    ...
    if node:
        for rel in ["config.js", "config.production.example.js", "assets/home.js", "assets/static-api.js"]:
