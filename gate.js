...
(function () {
  ...
  gateStyle.textContent = [
    ...
    '#rs-gate-overlay #rs-gate-input:focus,#rs-gate-overlay #rs-gate-input:focus-visible{outline:0!important;outline-offset:0!important;border-color:rgba(124,224,211,.82);background:rgba(255,255,255,.060);box-shadow:0 0 0 1px rgba(124,224,211,.58),0 0 0 3px rgba(124,224,211,.070),0 14px 34px rgba(2,8,20,.18),inset 0 1px 0 rgba(255,255,255,.070);}',
    ...
    '#rs-gate-overlay #rs-gate-submit:focus-visible{outline:2px solid rgba(124,224,211,.78);outline-offset:4px;box-shadow:inset 0 1px 0 rgba(255,255,255,.13),0 22px 50px rgba(3,10,24,.34);}',
