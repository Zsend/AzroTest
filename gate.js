/*
 * Reserve Standard — Stealth Gate v148 launch-ready
...
(function () {
  ...
  function sendTracker(eventName, details) {
    ...
    try {
      ...
      if ((config.loginTrackerMode || '').toLowerCase() === 'netlify') {
        var data = new URLSearchParams();
        data.set('form-name', config.loginTrackerFormName || 'rs-login-events');
