...
(function () {
  ...
  gateStyle.textContent = [
    ...
    'font-weight:500;}',
    '#rs-gate-overlay .rs-gate-title{font-family:"Source Serif 4",',
    'Georgia,serif;font-size:32px;font-weight:600;margin:0 0 16px;',
  ...
  function initGate() {
    ...
    overlay.setAttribute('aria-label', 'Stealth mode access');
    overlay.innerHTML = [
      '<div class="rs-gate-inner">',
      '<div class="rs-gate-eyebrow">Reserve Standard</div>',
      '<div class="rs-gate-title">Stealth mode.</div>',
      '<p class="rs-gate-lead">Reserve Standard is in private ',
      'founding-cohort release. Enter the access code shared with you ',
      'to continue.</p>',
      ...
      '</form>',
      '<p class="rs-gate-compliance">Educational market tool — not ',
      'financial, tax, or legal advice.</p>',
      '</div>'
    ].join('');
