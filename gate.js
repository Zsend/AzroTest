/*
 * Reserve Standard — Stealth Gate v95 launch-ready
 *
...
(function () {
  ...
  pendingStyle.textContent = 'html.rs-gate-pending,html.rs-gate-pending body{width:100%!important;min-height:100%!important;overflow:hidden!important;overscroll-behavior:none!important;background:#041225!important;}html.rs-gate-pending body{visibility:hidden!important;position:fixed!important;inset:0!important;}';
  ...
  gateStyle.textContent = [
    ...
    'min-height:100vh;min-height:100svh;min-height:100dvh;overflow:auto;overscroll-behavior:contain;-webkit-overflow-scrolling:touch;',
    ...
    '#rs-gate-overlay #rs-gate-input:focus,#rs-gate-overlay #rs-gate-input:focus-visible{outline:0!important;outline-offset:0!important;border-color:rgba(111,232,213,.72);background:rgba(255,255,255,.056);box-shadow:0 0 0 1px rgba(111,232,213,.46),0 0 0 3px rgba(111,232,213,.050),0 12px 30px rgba(2,8,20,.18),inset 0 1px 0 rgba(255,255,255,.066);}',
