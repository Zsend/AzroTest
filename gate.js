/*
 * Reserve Standard — Stealth Gate v101 launch-ready
 *
...
(function () {
  ...
  if (alreadyUnlocked) {
    ...
    if (!window.location.hash) {
      ...
      window.requestAnimationFrame(function () { try { window.scrollTo(0, 0); } catch (e) { /* ignore */ } });
      window.setTimeout(function () { try { window.scrollTo(0, 0); } catch (e) { /* ignore */ } }, 60);
    }
    return;
  }
  ...
  function initGate() {
    ...
    function unlock() {
      ...
      window.setTimeout(function () { window.scrollTo(0, 0); }, 40);
      window.setTimeout(function () { window.scrollTo(0, 0); }, 140);
      ...
      window.setTimeout(function () { window.scrollTo(0, 0); }, 420);
