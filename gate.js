...
(function () {
  ...
  gateStyle.textContent = [
    ...
    '#rs-gate-overlay #rs-gate-input:focus{border-color:rgba(92,214,187,.92);background:rgba(255,255,255,.065);box-shadow:0 0 0 3px rgba(92,214,187,.34),inset 0 1px 0 rgba(255,255,255,.06);}',
    ...
    '#rs-gate-overlay #rs-gate-submit:focus-visible{outline:3px solid #5CD6BB;outline-offset:4px;box-shadow:0 0 0 6px rgba(6,19,40,.78),inset 0 1px 0 rgba(255,255,255,.13),0 24px 54px rgba(3,10,24,.38);}',
